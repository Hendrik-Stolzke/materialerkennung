...
from mldog.app.plugins.liveThreeMaterialRecognition.materialDetection.dataPreparationProcessor_minimal10 import DataPreparationProcessor_minimal10
from mldog.app.plugins.liveThreeMaterialRecognition.materialDetection.mlPipelineProcessorThree import MlPipelineProcessorThree
...
class ThreeMaterialRecognitionTask(Task):
    """
    ...
    def __init__(self, ttl_max = 80, window_size = 48000, active_power = 50):
        ...
        self.processor = MultiProcessor([DataPreparationProcessor_minimal10(),MlPipelineProcessorThree("./pickleModel/bestModel.pkl")])
